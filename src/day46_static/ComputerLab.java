...
//        System.out.println(Computer.brand); --> NOT VALID because brand is the instance variable and we are trying to access by the class name, but we need an object
