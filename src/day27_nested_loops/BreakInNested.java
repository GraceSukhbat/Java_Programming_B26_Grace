...
public class BreakInNested {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // when the above break statement is run, we stop the outer loop, which means both will no longer run. We get 2 full iterations of the outer loop, including the inner loop running start to finish then when i is equal to 3 the outer loop will stop
            for (int j = 0; j < 2; j++) {
