...
Sample print statement:
   ...
   We ordered cheese pizza with 8 slices, 4 people ate 2 slices each with 0 left over
    ...
    public static void main(String[] args) {
        ...
        int slicePerPerson = numberOfSlices / numberOfPeople;
        int slicesLeftOver = numberOfSlices % numberOfPeople;
        String report = "We ordered " + typeOfPizza+ " pizza with " + numberOfSlices + " slices, " + numberOfPeople + " people ate " + slicePerPerson + " each with " + slicesLeftOver + " left over.";
